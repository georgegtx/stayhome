...
export default class Plot extends Component<Props, State> {
  ...
  render() {
    ...
    let infectedCB = <span><NodeLegend type="infected"/> &nbsp;Θετικοί: {infectedPercent}%</span>
    ...
    let recoveredCB = <span><NodeLegend type="removed"/> &nbsp;Ιάθηκαν: {recoveredPercent}%</span>
    ...
    if (this.props.showDeaths) {
      ...
      deadCB = <span><NodeLegend type="dead"/> <span style={{backgroundColor: '#FFA'}}>&nbsp;Νεκροί: {deadPercent}%&nbsp;</span></span>
    }
    ...
    return (
      <div>
        <div className="plot-container">
          ...
          <div className="plot-xaxis">χρόνος ⟶</div>
